...
export function BookingSuccessFlowContent({ basePath }: BookingSuccessFlowContentProps) {
  ...
  if (slot) {
    try {
      ...
      formattedSlot = d.toLocaleString(undefined, {
        weekday: 'short',
        month: 'short',
        day: 'numeric',
        hour: 'numeric',
        ...
        <div className="mx-auto max-w-md">
          ...
          <div className="cream-module">
            <div className="text-center py-2">
              ...
              <h1 className="text-2xl font-semibold tracking-tight text-emerald-800 mb-1">
                30 Second Booking Complete!
              </h1>
              <p className="text-sm text-neutral-600 mb-4">
                Thank you, {name.split(' ')[0] || 'friend'}. Your pro is on the way.
              </p>
                ...
                {qualifier && (
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="font-semibold text-emerald-700">
                      {qualifier.displayName || qualifier.code}
                    </span>
                  </div>
                )}
                {screenReinstall && (
