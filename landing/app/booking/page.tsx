  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 px-5 pt-12 pb-12">
        ...
        {showScreensModal && (
            <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/60 pt-8 px-4" onClick={() => { setShowScreensModal(false); setScreensChoice(""); }}>
              <div
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <button
                    onClick={() => { setShowScreensModal(false); setScreensChoice(""); }}
